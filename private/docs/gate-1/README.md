...
| [`tools.oracle`](https://github.com/waikato-ahuora-smart-energy-systems/pySPD/tree/main/tools/oracle) | Class-based staged runner, fail-closed overlay, parsers, comparator, and CLI | Implemented and tested |
