...
- Final prefix manifest:
  [`cplex-reference-paths-20230922-tp11-native-1e7.json`](../../../docs/validation/external-evidence.md)
- Independent support proof:
  [`cplex-reference-paths-20230922-tp11-support-polish.json`](../../../docs/validation/external-evidence.md)
- Decision record:
