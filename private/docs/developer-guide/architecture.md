...
The separate `multiperiod` package implements the analytic battery study; it is
not registered in the production GDX application. See the
[battery study](../../../docs/case-studies/battery-storage.md) for its own data and solve
contracts.
