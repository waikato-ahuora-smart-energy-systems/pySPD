...
The first [historical stress-event atlas](../../../docs/case-studies/historical-stress-event-atlas.md) now
...
The [minimal battery profile](../../../docs/case-studies/battery-storage.md) is now the first inter-period
...
formulation boundaries and the [validation guide](../../../docs/validation/index.md) for
