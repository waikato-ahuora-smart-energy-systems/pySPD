...
| Current decision | **IN PROGRESS — NOT YET PASS** |
...
This is not permission to claim release compatibility. The normative native
GAMS/CPLEX price oracle, corpus breadth, matrix exports, and independent review
remain open.
...
- Both profiles are independent characterization profiles. Neither replaces
  the required `gams-cplex-oracle` profile.
