...
|---|---|---|---|
| `G12-01` | Exactly 546 unique affected identities across all 139 Gate 1 hashes | All 139 hashes screened; 434-case algebraic lower bound proven, 112 active-node cases unresolved; oracle corrected to the disclosed `dailymode = 1` profile | In progress |
