...
|---|---|---|---|
| `G12-01` | Exactly 546 unique affected identities across all 139 Gate 1 hashes | Pinned v5.0.2 first-loop enumerator, atomic checkpoints, exact-manifest builder; governed corpus execution active | In progress |
